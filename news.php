          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <button data-toggle="modal" data-target="#addwork" class="btn btn-success pull-right"> Add News </button>
...
<div class="modal fade" id="addwork" role="dialog" tabindex="-1" aria-labeledby="Create Plan Modal">
   ...
   <input type="text" name="bookId" id="bookId" value=""  readonly=""   hidden="hidden" />
        ...
        <div class="col-md-12 col-sm-6 col-xs-12 form-group" >
         <label class="control-label col-md-4 col-sm-3 col-xs-12" id="l">News Titles  </label>
        <input type="text" name="name" id="name" class="form-control col-md-7 col-xs-12"  placeholder="Add Title">
        </div>
         ...
         <label class="control-label col-md-4 col-sm-3 col-xs-12" id="l1"> Description </label>
...
<div class="modal fade" id="addwork1" role="dialog" tabindex="-1" aria-labeledby="Create Plan Modal">
    <div class="modal-dialog" >
      ...
      <div class="modal-body1">
        ...
        <div class="col-md-12 col-sm-6 col-xs-12 form-group" >
         <label class="control-label col-md-4 col-sm-3 col-xs-12" id="l">News Titles  </label>
        <input type="text" name="name1" id="name1" class="form-control col-md-7 col-xs-12"  placeholder="Add Title">
        </div>
